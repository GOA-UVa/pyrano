...
VALUES (
    ...
    '2023-01-01 00:00:00'
) ON DUPLICATE KEY UPDATE latitude=VALUES(latitude), longitude=VALUES(longitude), elevation=VALUES(elevation), description=VALUES(description), created_at=VALUES(created_at);
